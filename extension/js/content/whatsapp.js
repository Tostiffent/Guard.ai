...
function appendDetectButtonInto(elementId) {
  ...
  for (var i = 0; i < targetElements.length; i++) {
    ...
    } else if (elementId == "x78zum5 x6s0dn4 x1totv3y") {
    ...
    if (
      ...
      targetElements[i]?.className == "x78zum5 x6s0dn4 x1totv3y"
    ) {
...
function appendConsentButtonInto(elementId) {
  ...
  var targetParentElement = parentElement.children[0].children[0].children[0];
  if (
...
const observer = new MutationObserver(function () {
  ...
  //video
  appendDetectButtonInto("x78zum5 x6s0dn4 x1totv3y");
